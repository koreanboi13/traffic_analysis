...
func TestLoadFromFile_EmptyTargetsMeansAll(t *testing.T) {
	path := writeTestRules(t, `
rules:
  - id: "test-001"
    name: "Test"
...
func TestLoadFromFile_DisabledRule(t *testing.T) {
	path := writeTestRules(t, `
rules:
  - id: "disabled-001"
    name: "Disabled"
...
func TestLoadFromFile_EmptyID(t *testing.T) {
	path := writeTestRules(t, `
rules:
  - id: ""
    name: "No ID"
...
func TestLoadFromFile_InvalidType(t *testing.T) {
	path := writeTestRules(t, `
rules:
  - id: "bad-type"
    name: "Bad Type"
...
func TestLoadFromFile_WeightOutOfRange(t *testing.T) {
	path := writeTestRules(t, `
rules:
  - id: "heavy"
    name: "Too Heavy"
